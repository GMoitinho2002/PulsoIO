...
namespace PulsoIO.Modules.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260803023623_AddUserClientScopeAndProfile")]
    partial class AddUserClientScopeAndProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PulsoIO.Modules.Identity.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PulsoIO.Modules.Identity.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PulsoIO.Modules.Identity.Domain.RefreshToken", b =>
                {
                    b.HasOne("PulsoIO.Modules.Identity.Domain.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
